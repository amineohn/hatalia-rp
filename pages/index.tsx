    ...
    <FadeIn className="flex justify-center items-center backdrop-blur-sm absolute w-full h-screen">
      <div className="flex flex-col">
        ...
        <div className="flex justify-center items-center">
          <button className="bg-white/70 rounded-3xl w-60 shadow shadow-[#E9D17C] px-0 py-6 text-[#E9D17C] hover:scale-105 transition transform">
            <a
